...
- Smex support for =helm-M-x= to remember choosen commands
...
#+BEGIN_SRC emacs-lisp
  ...
  (mapcar #'(lambda (package) (unless (package-installed-p package) (package-install package)))
          '(helm helm-swoop helm-flx helm-fuzzier smex dash))
#+END_SRC
...
To get it installed follow the instructions from:

https://github.com/ptrv/helm-smex.git

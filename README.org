...
Now you can bind keys for the helm-smex commands:
#+BEGIN_SRC emacs-lisp
...
and hide the echo in the minibuffer.
...
This is for the tangled file and the option to load the code 
provided by this guide as a whole in your init file.
